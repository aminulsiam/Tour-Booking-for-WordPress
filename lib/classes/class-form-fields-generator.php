	...
	class FormFieldsGenerator {
		...
		public function field_post_objects( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
					...
					if ( ! empty( $args ) ):
						foreach ( $args as $argsKey => $arg ):
                            ...
                            <div class="item">
								...
								<?php endif; ?>
                                <label>
                                    <input type="checkbox" <?php if ( in_array( $argsKey, $values ) ) {
										echo 'checked';
									} ?> value="<?php
		...
		public function field_switcher( $option ) {
			...
			?>
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo esc_attr( $id ); ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-switcher-wrapper
					...
					if ( ! empty( $args ) ) {
						foreach ( $args as $index => $arg ):
                            ...
                            <span unselectable="on"
                                  class="switcher-text <?php echo esc_attr( $index ); ?>"><?php echo esc_html( $arg );
								?></span>
						<?php
						endforeach;
					}
		...
		public function field_google_map( $option ) {
			...
			if ( ! empty( $args ) ):
                ...
                <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                        id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
					echo 'dependency-field';
				} ?> field-wrapper field-google-map-wrapper
		...
		public function field_border( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-border-wrapper
            field-border-wrapper-<?php echo $id; ?>">
                <div class="item-list">
                    <div class="item">
                        <span class="field-title">Width</span>
                        <span class="input-wrapper"><input type='number' name='<?php echo $field_name; ?>[width]'
                                                           value='<?php
						                                   echo $width; ?>'/></span>
		...
		public function field_dimensions( $option ) {
			...
			if ( ! empty( $args ) ):
                ...
                <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                        id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
					echo 'dependency-field';
				} ?> field-wrapper field-margin-wrapper
		...
		public function field_padding( $option ) {
			...
			if ( ! empty( $args ) ):
                ...
                <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                        id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
					echo 'dependency-field';
				} ?> field-wrapper field-padding-wrapper
		...
		public function field_margin( $option ) {
			...
			if ( ! empty( $args ) ):
                ...
                <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                        id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
					echo 'dependency-field';
				} ?> field-wrapper field-margin-wrapper field-margin-wrapper-<?php echo $id; ?>">
                    <label><input type="checkbox" class="change-together">Apply for all</label>
                    <div class="item-list">
						<?php
						foreach ( $args as $index => $arg ):
		...
		public function field_google_recaptcha( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-google-recaptcha-wrapper
...
// Verify the token on the server.
		...
		public function field_img_select( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-img-select-wrapper
                ...
                <div class="img-list">
					...
					foreach ( $args as $key => $arg ):
						...
						?><label class="<?php echo $checked; ?>" for='<?php echo $id; ?>-<?php echo $key; ?>'><input
                                ...
                                value='<?php echo $key; ?>' <?php echo $checked; ?>><span class="sw-button"><img
                                    data-id="<?php echo $id; ?>" src="<?php echo $arg; ?>"> </span></label><?php
		...
		public function field_submit( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-submit-wrapper
            field-submit-wrapper-<?php echo $id; ?>">
                <input type='submit' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
		...
		public function field_nonce( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-nonce-wrapper
		...
		public function field_color( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-color-wrapper
            field-color-wrapper-<?php echo $id; ?>">
                <input type='color' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'/>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_email( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-email-wrapper
            field-email-wrapper-<?php echo $id; ?>">
                <input type='email' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'/>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_password( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-password-wrapper
            field-password-wrapper-<?php echo $id; ?>">
                <input type='password' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'/>
		...
		public function field_search( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-search-wrapper
            field-search-wrapper-<?php echo $id; ?>">
                <input type='search' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'/>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_month( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-month-wrapper
            field-month-wrapper-<?php echo $id; ?>">
                <input type='time' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'/>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_date( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-date-wrapper
            field-date-wrapper-<?php echo $id; ?>">
                <input type='date' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'/>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_url( $option ) {
			...
			?>
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    class="<?php if ( ! empty( $depends ) ) {
						echo 'dependency-field';
					} ?> field-wrapper field-url-wrapper field-url-wrapper-<?php echo $id; ?>">
                <input type='url' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'/>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_time( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-time-wrapper
		...
		public function field_tel( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-tel-wrapper field-tel-wrapper-<?php
			echo $id; ?>">
                <input type='tel' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'/>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_text( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-text-wrapper
		...
		public function field_hidden( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-hidden-wrapper
		...
		public function field_text_multi( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-text-multi-wrapper
					...
					if ( ! empty( $values ) ):
						foreach ( $values as $value ):
                            ...
                            <div class="item">
                                ...
                                <span class="ppof-button remove"
                                      onclick="jQuery(this).parent().remove()"><?php echo( $remove_text ); ?></span>
                            </div>
						<?php
						endforeach;
					else:
...
"><?php echo( $remove_text ); ?></span>
		...
		public function field_textarea( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-textarea-wrapper field-textarea-wrapper-<?php echo $field_id; ?>">
		...
		public function field_code( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper  field-code-wrapper
            field-code-wrapper-<?php echo $field_id; ?>">
                <textarea name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>' cols='40' rows='5'
		...
		public function field_checkbox( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-checkbox-wrapper
            field-checkbox-wrapper-<?php echo $id; ?>">
				<?php
				foreach ( $args as $key => $argName ):
					$checked = ( $key == $value ) ? "checked" : "";
					?>
                    <label for='<?php echo $field_id; ?>'><input class="<?php echo $field_id; ?>"
                                                                 name='<?php echo $field_name; ?>' type='checkbox'
                                                                 id='<?php echo $field_id; ?>'
                                                                 value='<?php echo $key; ?>' <?php echo $checked; ?>><?php echo $argName; ?>
                    </label><br>
				<?php
				endforeach;
				?>
		...
		public function field_checkbox_multi( $option ) {
            ...
            field-checkbox-wrapper-<?php echo $id; ?>">
				...
				foreach ( $args as $key => $argName ):
					...
					?>
                    <label for='<?php echo $field_id . '-' . $key; ?>'><input class="<?php echo $field_id; ?>"
                                                                              name='<?php
					                                                          echo $field_name; ?>' type='checkbox'
                                                                              id='<?php echo $field_id . '-' . $key; ?>'
                                                                              value='<?php
					                                                          echo $key; ?>' <?php echo $checked; ?>><?php echo $argName; ?>
                    </label><br>
				<?php
				endforeach;
				?>
		...
		public function field_radio( $option ) {
            ...
            field-radio-wrapper-<?php echo $id; ?>">
				...
				foreach ( $args as $key => $argName ):
					$checked = ( $key == $value ) ? "checked" : "";
					?>
                    <label for='<?php echo $field_id . '-' . $key; ?>'><input name='<?php echo $field_name; ?>'
                                                                              type='radio'
                                                                              id='<?php echo $field_id . '-' . $key; ?>'
                                                                              value='<?php echo $key; ?>' <?php echo $checked; ?>><?php echo $argName; ?>
                    </label><br>
		...
		public function field_select( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-select-wrapper
                    ...
                    <select name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'>
						...
						foreach ( $args as $key => $argName ):
                            ...
                            <option <?php echo $selected; ?>
                                    value='<?php echo $key; ?>'><?php echo $argName; ?></option>
						<?php
						endforeach;
						?>
                    </select>
		...
		public function field_range( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-range-wrapper
            field-range-wrapper-<?php echo $id; ?>">
                <input type='range' min='<?php echo $min; ?>' max='<?php echo $max; ?>'
                       step='<?php echo $args['step']; ?>' name='<?php echo $field_name; ?>'
                       id='<?php echo $field_id; ?>' value='<?php echo $value; ?>'/>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_range_input( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-range-input-wrapper
            field-range-input-wrapper-<?php echo $id; ?>">
                <input type="number" class="range-val" name='<?php echo $field_name; ?>' value="<?php echo $value; ?>">
                <input type='range' class='range-hndle' id="<?php echo $field_id; ?>" min='<?php echo $args['min']; ?>'
                       max='<?php echo
		...
		public function field_switch( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-switch-wrapper
            field-switch-wrapper-<?php echo $id; ?>">
				...
				foreach ( $args as $key => $argName ):
					...
					?><label class="<?php echo $checked; ?>" for='<?php echo $id; ?>-<?php echo $key; ?>'><input
                            ...
                            value='<?php echo $key; ?>' <?php echo $checked; ?>><span
                            class="sw-button"><?php echo $argName; ?></span></label><?php
				endforeach;
				?>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_switch_multi( $option ) {
			...
			$id; ?>">
				...
				foreach ( $args as $key => $argName ):
					$checked = is_array( $value ) && in_array( $key, $value ) ? "checked" : "";
					?><label class="<?php echo $checked; ?>" for='<?php echo $field_id; ?>-<?php echo $key; ?>'><input
                            name='<?php echo $field_name; ?>[]' type='checkbox'
                            id='<?php echo $field_id; ?>-<?php echo $key; ?>'
                            value='<?php echo $key; ?>' <?php echo $checked; ?>><span
                            class="sw-button"><?php echo $argName; ?></span></label><?php
				endforeach;
				?>
		...
		public function field_switch_img( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-switch-img-wrapper
            field-switch-img-wrapper-<?php echo $id; ?>">
				...
				foreach ( $args as $key => $arg ):
					...
					?><label class="<?php echo $checked; ?>" for='<?php echo $id; ?>-<?php echo $key; ?>'><input
                            name='<?php echo $field_name; ?>' type='radio' id='<?php echo $id; ?>-<?php echo $key; ?>'
                            value='<?php echo $key; ?>' <?php echo $checked; ?>><span class="sw-button"><img
                                src="<?php echo $src; ?>"> </span></label><?php
		...
		public function field_time_format( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-time-format-wrapper
		...
		public function field_date_format( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-date-format-wrapper
		...
		public function field_datepicker( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-datepicker-wrapper
            field-datepicker-wrapper-<?php echo $id; ?>">
                <input type='text' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'/>
                <div class="error-mgs"></div>
            </div>
            <script>
		...
		public function field_colorpicker( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-colorpicker-wrapper
		...
		public function field_colorpicker_multi( $option ) {
			...
			if ( ! empty( $values ) ):
                ...
                <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                        id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
					echo 'dependency-field';
				} ?> field-wrapper field-colorpicker-multi-wrapper
		...
		public function field_link_color( $option ) {
			...
			$placeholder = isset( $option['placeholder'] ) ? $option['placeholder'] : "";
			$value       = isset( $option['value'] ) ? $option['value'] : "";
			$args        = isset( $option['args'] ) ? $option['args'] : array( 'link'    => '#1B2A41',
			                                                                   'hover'   => '#3F3244',
			                                                                   'active'  => '#60495A',
			                                                                   'visited' => '#7D8CA3'
			);
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-link-color-wrapper
            field-link-color-wrapper-<?php echo $id; ?>">
				...
				if ( ! empty( $values ) && is_array( $values ) ):
					foreach ( $args as $argindex => $value ):
						?>
                        <div>
                            <div class="item"><span class="title">a:<?php echo $argindex; ?> Color</span>
                                <div class="colorpicker"><input type='text' class='<?php echo $id; ?>'
                                                                name='<?php echo $field_name; ?>[<?php echo $argindex; ?>]'
                                                                value='<?php echo $values[ $argindex ]; ?>'/></div>
                            </div>
                        </div>
					<?php
					endforeach;
		...
		public function field_user( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-user-multi-wrapper
            field-user-multi-wrapper-<?php echo $id; ?>">
                <div class="users-wrapper">
					<?php if ( ! empty( $values ) ):
						foreach ( $values as $user_id ):
							...
							?>
                            <div class="item" title="click to remove"><img src="<?php echo $get_avatar_url; ?>"/><input
                                    type="hidden" name="<?php echo $field_name; ?>[]" value="<?php echo $user_id; ?>">
                            </div><?php
						endforeach;
					endif; ?>
                </div>
                <div class="user-list">
                    ...
                    <div class="search-user"><input class="" type="text"
                                                    placeholder="<?php echo __( 'Start typing...', 'pickplugins-options-framework' ); ?>">
                    </div>
                    <ul>
						<?php
						if ( ! empty( $icons ) ):
		...
		public function field_icon( $option ) {
            ...
            field-icon-wrapper-<?php echo $id; ?>">
                ...
                <div class="icon-list">
                    ...
                    <div class="search-icon"><input class="" type="text"
                                                    placeholder="<?php echo __( 'Start typing...', 'pickplugins-options-framework' ); ?>">
                    </div>
                    <ul>
						<?php
						if ( ! empty( $icons ) ):
							foreach ( $icons as $iconindex => $iconTitle ):
								?>
                                <li title="<?php echo $iconTitle; ?>" iconData="<?php echo $iconindex; ?>"><i
                                            class="<?php echo $iconindex; ?>"></i></li>
							<?php
							endforeach;
						endif;
						?>
		...
		public function field_icon_multi( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-icon-multi-wrapper
            field-icon-multi-wrapper-<?php echo $id; ?>">
                <div class="icons-wrapper">
					<?php if ( ! empty( $values ) ):
						foreach ( $values as $value ):
							?>
                            <div class="item" title="click to remove"><span><i class="<?php echo $value; ?>"></i></span><input
                                    type="hidden" name="<?php echo $field_name; ?>[]" value="<?php echo $value; ?>">
                            </div><?php
						endforeach;
					endif; ?>
                </div>
                    ...
                    <ul>
						...
						if ( ! empty( $icons ) ):
							foreach ( $icons as $iconindex => $iconTitle ):
								?>
                                <li title="<?php echo $iconTitle; ?>" iconData="<?php echo $iconindex; ?>"><i
                                        class="<?php echo $iconindex; ?>"></i></li><?php
							endforeach;
						endif;
						?>
                    </ul>
		...
		public function field_number( $option ) {
			...
			$max         = isset( $option['max'] ) ? $option['max'] : 30;
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-number-wrapper
             field-number-wrapper-<?php echo $id; ?>">
                <input type='number' class='' name='<?php echo $field_name; ?>' id='<?php echo $field_id; ?>'
                       placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>'
                       min="<?php _e($min); ?>" max="<?php _e($max);?>"/>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_wp_editor( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-wp_editor-wrapper
		...
		public function field_select2( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-select2-wrapper
		...
		public function field_option_group( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-option-group-tabs-wrapper
            ...
            field-option-group-tabs-wrapper-<?php echo $id; ?>">
                ...
                <ul class="tab-navs">
					...
					foreach ( $args as $key => $value ):
						$title = $value['title'];
						?>
                        <li index="<?php echo $i; ?>" class="<?php if ( $i == 1 ) {
							echo 'active';
						} ?>"><?php echo $title; ?></li>
						<?php
						$i ++;
				...
				foreach ( $args as $key => $value ):
					...
					?>
                    <div class="tab-content tab-content-<?php echo $i; ?> <?php if ( $i == 1 ) {
						echo 'active';
					} ?>">
		...
		public function field_option_group_accordion( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-faq-wrapper
		...
		public function field_grid( $option ) {
			...
			$args       = isset( $option['args'] ) ? $option['args'] : "";
			$conditions = isset( $option['conditions'] ) ? $option['conditions'] : array();
			$widths     = isset( $option['width'] ) ? $option['width'] : array( '768px'  => '100%',
			                                                                    '992px'  => '50%',
			                                                                    '1200px' => '30%',
			);
			$heights    = isset( $option['height'] ) ? $option['height'] : array( '768px'  => 'auto',
			                                                                      '992px'  => '250px',
			                                                                      '1200px' => '250px',
			);
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-grid-wrapper
            field-grid-wrapper-<?php echo $id; ?>">
				...
				foreach ( $args as $key => $grid_item ) {
					...
					?>
                    <div class="item">
                        <div class="thumb"><a href="<?php echo $link; ?>"><img src="<?php echo $thumb; ?>"></img></a>
                        </div>
		...
		public function field_color_sets( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-color-sets-wrapper
            field-color-sets-wrapper-<?php echo $id; ?>">
                ...
                <label class="<?php echo $checked; ?>" for='<?php echo $id; ?>-<?php echo $key; ?>'>
                    <input name='<?php echo $field_name; ?>' type='radio' id='<?php echo $id; ?>-<?php echo $key; ?>'
            ...
            <style type="text/css">
                ...
                <?php endif; ?><?php if(!empty($height)):  ?> height: <?php echo $height; ?>;
                <?php endif; ?>
                }
		...
		public function field_image_link( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-image-link-wrapper
            field-image-link-wrapper-<?php echo $id; ?>">
                ...
                <div class="val-wrap">
                    ...
                    <span class='ppof-button upload'
                          id='media_upload_<?php echo $id; ?>'><?php echo __( 'Upload', 'pickplugins-options-framework' ); ?></span>
                    <span class="ppof-button clear">Clear</span>
                </div>
                <div class="error-mgs"></div>
            </div>
            <script>jQuery(document).ready(function ($) {
		...
		public function field_color_palette( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-color-palette-wrapper
            field-color-palette-wrapper-<?php echo $id; ?>">
				...
				foreach ( $colors as $key => $color ):
					...
					?><label  class="<?php echo $checked; ?>" for='<?php echo $id; ?>-<?php echo $key; ?>'><input
                            name='<?php echo $field_name; ?>' type='radio' id='<?php echo $id; ?>-<?php echo $key; ?>'
                            value='<?php echo $key; ?>' <?php echo $checked; ?>><span title="<?php echo $color; ?>"
                                                                                      style="background-color: <?php
					                                                                  echo $color; ?>"
                                                                                      class="sw-button"></span>
                    <span class="checked-icon"><i class="fas fa-check"></i></span>
                    </label><?php
				endforeach;
				?>
		...
		public function field_color_palette_multi( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-color-palette-multi-wrapper
		...
		public function field_media( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-media-wrapper
            field-media-wrapper-<?php echo $id; ?>">
                <div class='media_preview'
					...
					if ( "audio/mpeg" == $media_type ) {
						?>
                        <div id='media_preview_$id' class='dashicons dashicons-format-audio'
                             style='font-size: 70px;display: inline;'></div>
                ...
                <input type='hidden' name='<?php echo $field_name; ?>' id='media_input_<?php echo $id; ?>'
                       value='<?php echo $value; ?>'/>
                <div class='ppof-button upload'
                     id='media_upload_<?php echo $id; ?>'><?php echo __( 'Upload', 'pickplugins-options-framework' ); ?></div>
                <div class='ppof-button clear'
                     id='media_clear_<?php echo $id; ?>'><?php echo __( 'Clear', 'pickplugins-options-framework' ); ?></div>
                <div class="error-mgs"></div>
            </div>
		...
		public function field_media_multi( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-media-multi-wrapper
					...
					if ( ! empty( $values ) && is_array( $values ) ):
						foreach ( $values as $value ):
                            ...
                            <div class="item">
                                ...
                                <img id='media_preview_<?php echo $id; ?>' src='<?php echo $media_url; ?>'
                                     style='width:100%'/>
		...
		public function field_repeatable( $option ) {
            ...
            <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo $depends; ?>]" <?php } ?>
                    id="field-wrapper-<?php echo $id; ?>" class="<?php if ( ! empty( $depends ) ) {
				echo 'dependency-field';
			} ?> field-wrapper field-repeatable-wrapper
                ...
                <div class="field-list <?php if ( $sortable ) {
					...
					if ( ! empty( $values ) ):
						...
						foreach ( $values as $index => $val ):
							...
							?>
                            <div class="item-wrap <?php if ( $collapsible ) {
								echo 'collapsible';
							} ?>">
								<?php if ( $collapsible ): ?>
                                <div class="header">
                                    ...
                                    <span class="button remove"
                                          onclick="jQuery(this).parent().parent().remove()"><?php echo $remove_text; ?></span>
                                    <!--                                    <span index_id="--><?php //echo $index;
									?><!--" class="button clone"><i class="far fa-clone"></i></span>-->
									<?php if ( $sortable ): ?>
                                        <span class="button sort"><i class="fas fa-arrows-alt"></i></span>
									<?php endif; ?>
                                        ...
                                        <div class="content">
											...
											<?php if ( $type == 'text' ):
                                                ...
                                                <input type="text" class="regular-text"
                                                       name="<?php echo $field_name; ?>[<?php echo $index; ?>][<?php echo $item_id; ?>]"
                                                       placeholder="" value="<?php echo esc_html( $value ); ?>">
											...
											<?php elseif ( $type == 'time' ):
												...
												$value = ! empty( $val[ $item_id ] ) ? $val[ $item_id ] : $default;
												?>
                                                <input type="time" class="regular-text"
                                                       name="<?php echo $field_name; ?>[<?php echo $index; ?>][<?php echo $item_id; ?>]"
                                                       placeholder="" value="<?php echo esc_html( $value ); ?>">
											...
											<?php elseif ( $type == 'month' ):
												...
												$value = ! empty( $val[ $item_id ] ) ? $val[ $item_id ] : $default;
												?>
                                                <input type="month" class="regular-text"
                                                       name="<?php echo $field_name; ?>[<?php echo $index; ?>][<?php echo $item_id; ?>]"
                                                       placeholder="" value="<?php echo esc_html( $value ); ?>">
											<?php elseif ( $type == 'color' ):
												...
												$value = ! empty( $val[ $item_id ] ) ? $val[ $item_id ] : $default;
												?>
                                                <input type="color" class="regular-text"
                                                       name="<?php echo $field_name; ?>[<?php echo $index; ?>][<?php echo $item_id; ?>]"
                                                       placeholder="" value="<?php echo esc_html( $value ); ?>">
											...
											<?php elseif ( $type == 'textarea' ):
												...
												?>
                                                <textarea
                                                        name="<?php echo $field_name; ?>[<?php echo $index; ?>][<?php echo $item_id; ?>]"><?php echo esc_html( $value ); ?></textarea>
											<?php elseif ( $type == 'select' ):
                                                ...
                                                <select class=""
													...
													<?php foreach ( $args as $argIndex => $argName ):
														...
														?>
                                                        <option <?php echo $selected; ?>
                                                                value="<?php echo $argIndex; ?>"><?php echo $argName; ?></option>
													<?php endforeach; ?>
                                                </select>
											<?php elseif ( $type == 'radio' ):
                                                ...
                                                <label class="">
                                                    <input type="radio"
                                                           name="<?php echo $field_name; ?>[<?php echo $index; ?>][<?php echo $item_id; ?>]" <?php echo $checked; ?>
                                                           value="<?php echo $argIndex; ?>"><?php echo $argName; ?></input>
                                                </label>
											<?php endforeach; ?>
		...
		public function args_from_string( $string ) {
			...
			if ( strpos( $string, 'PAGES_IDS_ARRAY' ) !== false ) {
				return $this->get_pages_array();
			}
			if ( strpos( $string, 'POSTS_IDS_ARRAY' ) !== false ) {
				return $this->get_posts_array();
			}
			if ( strpos( $string, 'POST_TYPES_ARRAY' ) !== false ) {
			...
			if ( strpos( $string, 'USER_IDS_ARRAY' ) !== false ) {
				return $this->get_user_ids_array();
			}
			if ( strpos( $string, 'MENUS' ) !== false ) {
				return $this->get_menus_array();
			}
			if ( strpos( $string, 'SIDEBARS_ARRAY' ) !== false ) {
				return $this->get_sidebars_array();
			}
			if ( strpos( $string, 'THUMB_SIEZS_ARRAY' ) !== false ) {
				return $this->get_thumb_sizes_array();
			}
			if ( strpos( $string, 'FONTAWESOME_ARRAY' ) !== false ) {
		...
		public function get_user_ids_array() {
			...
			foreach ( $users as $user ) {
				$user_ids[ $user->ID ] = $user->display_name . '(#' . $user->ID . ')';
			}
		...
		public function get_posts_array() {
			...
			$posts_array = array();
			foreach ( get_posts( array( 'posts_per_page' => - 1 ) ) as $page ) {
