                                    ...
                                    <ul class="child-navs">
										...
										foreach ( $page_settings as $section_id => $nav_sections ):
                                            ...
                                            <li>
                                                ...
                                                <a sectionId="<?php echo $section_id; ?>"
                                                   dataid="<?php echo $page_id; ?>" href='#<?php echo $section_id; ?>'
                                                   class='nav-item <?php if ( $current_page == $page_id ) {
													   echo 'active';
						...
						foreach ( $this->get_panels() as $panelsIndex => $panel ):
							...
							echo $panelsIndex; ?>">
								...
								foreach ( $panel['sections'] as $sectionIndex => $section ):
                                    ...
                                    <pre><?php //echo var_export($section, true);
										?></pre>
								<?php
